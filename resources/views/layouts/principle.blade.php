...
<head>
    ...
    <script src="{{ asset('assets/vendor/libs/trix-editor/js/trix.umd.min.js') }}"></script>
...
<body>
    ...
    @auth
        ...
        <div class="layout-wrapper layout-content-navbar">
            <div class="layout-container">
                ...
                @include('partials.principle.sidebar')

                <div class="layout-page">

                    @include('partials.principle.navbar')

                    <div class="content-wrapper">
                        @yield('section-principle')

                        @include('partials.principle.footer')
    ...
    <script src="{{ asset('assets/js/script-principle.js') }}"></script>
