            ...
            <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto">
                    <li class="nav-item {{ request()->routeIs('/') ? 'active' : '' }}">
                        <a class="nav-link fw-medium" aria-current="page" href="{{ route('/') }}">Home</a>
                    </li>
                    <li class="nav-item {{ request()->routeIs('guide') ? 'active' : '' }}">
                        <a class="nav-link fw-medium" href="{{ route('guide') }}">Panduan</a>
                    </li>
                </ul>
            </div>
            ...
            <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li>
                    <a href="{{ route('signin') }}" class="btn btn-primary"><span
                            ...
                            class="d-none d-md-block">Masuk/Daftar</span></a>
                </li>
                <!-- navbar button: End -->
            </ul>
            <!-- Toolbar: End -->
