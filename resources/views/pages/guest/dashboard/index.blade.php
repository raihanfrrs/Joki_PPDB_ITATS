                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled my-4">
                                        ...
                                        <li class="mb-2">
                                            <a href="help-center-article.html"
                                                class="text-body d-flex justify-content-between align-item-center">
                                                <span class="text-truncate me-2 me-lg-4"> How do I purchase an item?
                                                </span>
                                                <i class="ti ti-chevron-right scaleX-n1-rtl text-muted"></i>
                                            </a>
                                        </li>
                                        <li class="mb-2">
                                            <a href="help-center-article.html"
                                                class="text-body d-flex justify-content-between align-item-center">
                                                <span class="text-truncate me-2 me-lg-4"> How do i add or change my
                                                    details? </span>
                                                <i class="ti ti-chevron-right scaleX-n1-rtl text-muted"></i>
                                            </a>
                                        </li>
                                        ...
                                        <li>
                                            <a href="help-center-article.html"
                                                class="text-body d-flex justify-content-between align-item-center">
                                                <span class="text-truncate me-2 me-lg-4"> I'm trying to find a specific
                                                    item </span>
                                                <i class="ti ti-chevron-right scaleX-n1-rtl text-muted"></i>
                                            </a>
                                        </li>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <span class="badge bg-label-primary p-2 rounded me-2"><i
                                                class="ti ti-help-circle ti-sm"></i></span>
                                    ...
                                    <ul class="list-unstyled my-4">
                                        ...
                                        <li class="mb-2">
                                            <a href="help-center-article.html"
                                                class="text-body d-flex justify-content-between align-item-center">
                                                <span class="text-truncate me-2 me-lg-4"> Where Is My Purchase Code?
                                                </span>
                                                <i class="ti ti-chevron-right scaleX-n1-rtl text-muted"></i>
                                            </a>
                                        </li>
                                        <li class="mb-2">
                                            <a href="help-center-article.html"
                                                class="text-body d-flex justify-content-between align-item-center">
                                                <span class="text-truncate me-2 me-lg-4"> Extend or renew Item Support
                                                </span>
                                                <i class="ti ti-chevron-right scaleX-n1-rtl text-muted"></i>
                                            </a>
                                        </li>
                                        ...
                                        <li>
                                            <a href="help-center-article.html"
                                                class="text-body d-flex justify-content-between align-item-center">
                                                <span class="text-truncate me-2 me-lg-4"> Why has my item been removed?
                                                </span>
                                                <i class="ti ti-chevron-right scaleX-n1-rtl text-muted"></i>
                                            </a>
                                        </li>
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled my-4">
                                        ...
                                        <li class="mb-2">
                                            <a href="help-center-article.html"
                                                class="text-body d-flex justify-content-between align-item-center">
                                                <span class="text-truncate me-2 me-lg-4"> How do licenses work for any
                                                    plugins </span>
                                                <i class="ti ti-chevron-right scaleX-n1-rtl text-muted"></i>
                                            </a>
                                        </li>
                                        <li class="mb-2">
                                            <a href="help-center-article.html"
                                                class="text-body d-flex justify-content-between align-item-center">
                                                <span class="text-truncate me-2 me-lg-4"> For logo what license do I need?
                                                </span>
                                                <i class="ti ti-chevron-right scaleX-n1-rtl text-muted"></i>
                                            </a>
                                        </li>
                                        ...
                                        <li>
                                            <a href="help-center-article.html"
                                                class="text-body d-flex justify-content-between align-item-center">
                                                <span class="text-truncate me-2 me-lg-4"> I want to make multiple end
                                                    products </span>
                                                <i class="ti ti-chevron-right scaleX-n1-rtl text-muted"></i>
                                            </a>
                                        </li>
                        ...
                        <div class="col-md-4 col-sm-6 mb-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <span class="badge bg-label-primary p-2 rounded me-2"><i
                                                class="ti ti-color-swatch ti-sm"></i></span>
                                    ...
                                    <ul class="list-unstyled my-4">
                                        ...
                                        <li class="mb-2">
                                            <a href="help-center-article.html"
                                                class="text-heading d-flex justify-content-between align-items-center">
                                                <span class="text-truncate me-1"> Elementor Template Kits: PHP Zip File
                                                    Missing </span>
                                                <i class="ti ti-chevron-right scaleX-n1-rtl text-muted"></i>
                                            </a>
                                        </li>
                                        <li class="mb-2">
                                            <a href="help-center-article.html"
                                                class="text-heading d-flex justify-content-between align-items-center">
                                                <span class="text-truncate me-1"> Template Kits - Imported template is
                                                    blank or broken </span>
                                                <i class="ti ti-chevron-right scaleX-n1-rtl text-muted"></i>
                                            </a>
                                        </li>
                                        <li class="mb-2">
                                            <a href="help-center-article.html"
                                                class="text-body d-flex justify-content-between align-item-center">
                                                <span class="text-truncate me-2 me-lg-4"> Troubleshooting Import Problems
                                                </span>
                                                <i class="ti ti-chevron-right scaleX-n1-rtl text-muted"></i>
                                            </a>
                                        </li>
                                        <li class="mb-2">
                                            <a href="help-center-article.html"
                                                class="text-body d-flex justify-content-between align-item-center">
                                                <span class="text-truncate me-2 me-lg-4"> How to use the WordPress Plugin
                                                </span>
                                                <i class="ti ti-chevron-right scaleX-n1-rtl text-muted"></i>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="help-center-article.html"
                                                class="text-heading d-flex justify-content-between align-items-center">
                                                <span class="text-truncate me-1"> How to use the Template Kit Importer
                                                    Plugin </span>
                                                <i class="ti ti-chevron-right scaleX-n1-rtl text-muted"></i>
                                            </a>
                                        </li>
                        ...
                        <div class="col-md-4 col-sm-6 mb-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <span class="badge bg-label-primary p-2 rounded me-2"><i
                                                class="ti ti-lock-open ti-sm"></i></span>
                                    ...
                                    <ul class="list-unstyled my-4">
                                        <li class="mb-2">
                                            <a href="help-center-article.html"
                                                class="text-body d-flex justify-content-between align-item-center">
                                                <span class="text-truncate me-2 me-lg-4"> Signing in with a social account
                                                </span>
                                                <i class="ti ti-chevron-right scaleX-n1-rtl text-muted"></i>
                                            </a>
                                        </li>
                                        ...
                                        <li class="mb-2">
                                            <a href="help-center-article.html"
                                                class="text-body d-flex justify-content-between align-item-center">
                                                <span class="text-truncate me-2 me-lg-4"> I'm not receiving the
                                        ...
                                        <li class="mb-2">
                                            <a href="help-center-article.html"
                                                class="text-body d-flex justify-content-between align-item-center">
                                                <span class="text-truncate me-2 me-lg-4"> Forgotten Username Or Password
                                                </span>
                                                <i class="ti ti-chevron-right scaleX-n1-rtl text-muted"></i>
                                            </a>
                                        </li>
                                        ...
                                        <li>
                                            <a href="help-center-article.html"
                                                class="text-body d-flex justify-content-between align-item-center">
                                                <span class="text-truncate me-2 me-lg-4"> What is Sign In Verification?
                                                </span>
                                                <i class="ti ti-chevron-right scaleX-n1-rtl text-muted"></i>
                                            </a>
                                        </li>
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled my-4">
                                        <li class="mb-2">
                                            <a href="help-center-article.html"
                                                class="text-body d-flex justify-content-between align-item-center">
                                                <span class="text-truncate me-2 me-lg-4"> How do I change my password?
                                                </span>
                                                <i class="ti ti-chevron-right scaleX-n1-rtl text-muted"></i>
                                            </a>
                                        </li>
                                        <li class="mb-2">
                                            <a href="help-center-article.html"
                                                class="text-body d-flex justify-content-between align-item-center">
                                                <span class="text-truncate me-2 me-lg-4"> How do I change my username?
                                                </span>
                                                <i class="ti ti-chevron-right scaleX-n1-rtl text-muted"></i>
                                            </a>
                                        </li>
                                        <li class="mb-2">
                                            <a href="help-center-article.html"
                                                class="text-body d-flex justify-content-between align-item-center">
                                                <span class="text-truncate me-2 me-lg-4"> How do I close my account?
                                                </span>
                                                <i class="ti ti-chevron-right scaleX-n1-rtl text-muted"></i>
                                            </a>
                                        </li>
                                        <li class="mb-2">
                                            <a href="help-center-article.html"
                                                class="text-body d-flex justify-content-between align-item-center">
                                                <span class="text-truncate me-2 me-lg-4"> How do I change my email address?
                                                </span>
                                                <i class="ti ti-chevron-right scaleX-n1-rtl text-muted"></i>
                                            </a>
                                        </li>
                                        <li class="mb-2">
                                            <a href="help-center-article.html"
                                                class="text-body d-flex justify-content-between align-item-center">
                                                <span class="text-truncate me-2 me-lg-4"> How can I regain access to my
                                                    account? </span>
                                                <i class="ti ti-chevron-right scaleX-n1-rtl text-muted"></i>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="help-center-article.html"
                                                class="text-body d-flex justify-content-between align-item-center">
                                                <span class="text-truncate me-2 me-lg-4"> Are RSS feeds available on
                                                    Market? </span>
                                                <i class="ti ti-chevron-right scaleX-n1-rtl text-muted"></i>
                                            </a>
                                        </li>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 text-center">
                    ...
                    <p class="mb-3">
                        Our specialists are always happy to help.<br />Contact us during standard business hours or email us
                        24/7
