...
@section('title', 'PPDB - Master Principle - Create')
...
@section('section-admin')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                    <h5 class="card-header">Data Kepala Sekolah</h5>
                    <form action="{{ route('master.principle.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control @error('nip') is-invalid @enderror" type="text"
                                        value="{{ old('nip') }}" id="nip" name="nip" required>
                                    @error('nip')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control @error('pob') is-invalid @enderror" type="pob"
                                        value="{{ old('pob') }}" id="pob" name="pob" required>
                                    @error('pob')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control @error('dob') is-invalid @enderror" type="date"
                                        value="{{ old('dob', Carbon\Carbon::now()->format('Y-m-d')) }}" id="dob"
                                        name="dob" required>
                                    @error('dob')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control @error('username') is-invalid @enderror" type="text"
                                        value="{{ old('username') }}" id="username" name="username" required>
                                    @error('username')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
