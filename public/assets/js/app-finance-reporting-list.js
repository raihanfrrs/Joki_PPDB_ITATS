...
// Datatable (jquery)
function tbl_finance_reporting () {
  ...
  var dt_brand_table = $('#listReportingFinanceTable');

  if (dt_brand_table.length) {
    var dt_user = dt_brand_table.DataTable({
      ajax: "/listReportingFinanceTable",
      columns: [
        { data: '' },
        { data: 'index', class: 'text-center' },
        { data: 'student', class: 'text-center' },
        { data: 'registration_at', class: 'text-center' },
      ...
      columnDefs: [
        ...
        },
        {
          targets: 3,
          render: function (data, type, full, meta) {
            return full.registration_at;
          }
        },
        {
          targets: 4,
          render: function (data, type, full, meta) {
            return full.payment_at;
          }
        },
        {
          targets: 5,
